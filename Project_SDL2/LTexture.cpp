...
void LTexture::render(SDL_Renderer* &gRenderer, int x, int y, SDL_Point* center, const SDL_Rect* clip, double angle, SDL_RendererFlip flip)
{
...
bool LTexture::loadFromRenderedText(SDL_Renderer* &gRenderer, std::string textureText, SDL_Color textColor )
{
    ...
    TTF_Font *gFont = TTF_OpenFont("Font.ttf", 20);
    //Render text surface
